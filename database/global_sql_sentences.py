...
initial_server_sql="""PRAGMA foreign_keys = ON;
...
desc_initial_server_sql="""pragma table_info(builds);
                            pragma table_info(sql_sentences);
                            pragma table_info(build_sql_sentences)"""
...
first_build="""DROP TABLE IF EXISTS updates;
